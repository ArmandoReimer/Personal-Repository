...
% specially formatted tick labels. The third window also demonstrates various
% ways of modifying the grid lines, and also shows the use of the "+ - < > ."
...
%
% Demonstrates how to define a new plotting function (pltpub in this example)
...
fclose(f);
pltpub(Pvbar(t,950,v),'Pos',[5 522 1140 440],'xy',[.069 .128 .641 .850],...
...
h = pltpub(t,y,'Figname','Plot 2: Publications with subplots','Pos',[800 480],...
    'SubPlot',[32 32 33 -50 49 49],'SubTrace',3*ones(1,5),'TraceC',('brkbrkbrkbrkbrk')',...
    ...
    'xy',[.062 .075 .920 .920],'Options','LineSmoothing','Link',link);
...
p = [ 0 .100 .130 .820 .840;  % position: plotting axis
     -1 .360 .164 .248 .112]; % position: TraceID box
xx = pltpub('Right',1:2,time,temp,Pebar(time,temp,tempL,tempU,60),...
   ...
   '+XtickLabel',' ','Pos',[820 5 670 480],'Link',link);
