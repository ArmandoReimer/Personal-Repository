function [loc,TaskH,TaskW] = TaskbarSZ()       % Returns the taskbar location.

% This function will only be called (from screencfg.m) only in unusual situations
% (such as with very old versions of Matlab) where the java frame does not exist.
% So don't bother editing this function or reading farther unless you notice a
% problem with taskbar positioning.
