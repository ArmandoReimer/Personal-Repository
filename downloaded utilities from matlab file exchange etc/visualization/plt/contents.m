% plt.m:   An alternative to plot and plotyy (version 03Jan20)
...
% plt(...,'+',n)          : Reserve space for n more traces in the TraceID box (for pltt)
...
%                           'noButton'      disables the cursor button group (4 buttons)
...
% plt('Fig',n,...)        : Opens plt in figure #n (Must be the 1st or last in argument list)
...
% plt('image',...)       : function for creating intensity map pseudo objects
% plt('HelpText',...)    : function for creating HelpText pseudo objects
