...
function [IClust,EL,NUMEllipses] = runMergeFitting(I,AICBIC_SELECTION)
Iorig = I;
lines = size(I,1);
cols = size(I,2);
...
[EL,IClust,TotalPerf,NUMEllipses,area,AIC,BIC,minAICBIC,SI,nCompl,hfig1] = runFastMergeAlgo(IClust,lines,cols,AICBIC_SELECTION);
