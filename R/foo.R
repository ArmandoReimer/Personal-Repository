...
# seq creates evenly spaced values. our guy is probably somewhere near .5
df1 <- data.frame(theta = seq(0.375, 0.525, 0.001)) 
a <- 438 #ngirls + 1
b <- 544 #total kids - ngirls + 1 = nboys + 1
# dbeta computes the posterior density
# $ references a name. like a dot references a structure field in matlab
