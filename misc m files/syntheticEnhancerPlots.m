...
% title('Prediction for Gene Expression Rate')
% xlabel('AP')
% ylabel('Gene Expression Rate')
% set(gca,'fontsize',14)
% 
% figure(12)
...
% hold off;
% title({'Dependence of Rate on', 'Position of Bcd Binding Site'},'FontSize',14)
% xlabel('AP')
% ylabel('Gene Expression Rate')
% set(gca,'fontsize',14)
% l = legend('- 4','- 1','+ 5');
...
% figure(14)
% plot([-5:5], rateHelical,'-b', 'LineWidth',lineWidth)
% title('Rate at 0.5 AP by Construct', 'FontSize',14) 
% axis([-6 6 0.3 0.7])
% xlabel('Position of Bcd Binding Site (Phase Shift)')
% ylabel('Gene Expression Rate at 0.5 AP')
% set(gca,'fontsize',14)
% 
% txt1 = '- 4';
% text(-3.5,0.4,txt1,'FontSize',14)
% txt2 = '- 1';
% text(-1.85,0.65,txt2,'FontSize',14)
% txt3 = '+ 5';
% text(5,0.335,txt3,'FontSize',14)
% 
% B=0;