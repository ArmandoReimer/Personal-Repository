function syntheticAnalysis(dataset)
%syntheticAnalysis(dataset)
%
%DESCRIPTION
%Perform analyses on time traces from different enhancer
%datasets and generate graphs. Critically, this always uses same 0A3 control data in addition 
%to the dataset passed in the argument.
%
%PARAMETERS
