...
displayAverage = 0;
    ...
    params.MCP_INTENSITY = .5; %au / frame / mcp-gfp
    
%     params.FLUO_CALIBRATION = 20; %au / polymerase
    ...
    params.N_POLS = params.GENE_LENGTH / params.POL_FOOTPRINT;
...
%     fluosMask = fluos==0; %keep track of where the zeroes were
    singleFluosTrunc = fluos.*(fluos>params.detectionLimit); %set values below limit to zero
